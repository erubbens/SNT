...
• De façon fondamentale, le Web est constitué de l'ensemble des documents hypertextes (pages [HTML](Séance 1_ présentation HTML.md) auxquels il donne accès : on relie un document à un autre à l'aide d'un lien qu'on peut utiliser pour basculer vers un nouveau contenu hypertexte sans avoir à parcourir l'ensemble du document initial.
