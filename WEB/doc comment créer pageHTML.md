...
Le rôle du fichier _**HTML**_ (_**HyperText Markup Language**_) est d’organiser  le contenu brut de la page,  
le rôle du fichier _**CSS (Cascading Style Sheets)**_ est de gérer la mise en forme c’est-à-dire l’apparence de la page web.
...
-	les balises en paires : une ouvrante, une fermante. exemple : ```<title>  </title>``` 
...
- _**Créer des liens**_
	...
	- Lien vers un site existant : ```<a href=“http://adresse.com“> Lien vers ce site </a>```
	...
	- Lien vers une ancre, c’est-à-dire un repère dans la page, ce qui peut être utile si la page est longue.
	 ...
	 puis on revient en début de document taper le lien vers cet identifiant:```<a href="#monparagraphe"> Lien vers mon paragraphe </a>```

	- Lien pour télécharger un fichier, on fait un lien en indiquant simplement le nom du fichier à télécharger :  
